...
mongoose.connect(
    "mongodb+srv://sibi:arunsibi@hospital-systems.wgqwd8m.mongodb.net/hospital-management-systems-db?retryWrites=true&w=majority"
    );
...
app.get("/update/:id",(req,res)=>{
    if(req.isAuthenticated()){
     patients.findOne({patient_name:req.params.id})
     .then((data)=>{
...
app.get("/delete/:id",(req,res)=>{
    if(req.isAuthenticated()){
        patients.deleteOne({patient_name:req.params.id})
    .then((data)=>{
